...
/**
 * Encapsulates a screensaver in an applet. This is a convenient way to display a 'screenshot' of a screensaver in a
 * web-page.
 *
 ...
 * </pre>
 *
 * Note that you need to list the Screensaver jar in the 'archives' attribute, the 'class' is the ScreensaverApplet
 * itself, which uses the 'saverClass' parameter as the name of the SimpleSaver derivative you wish to display.
 *
 * Saver parameters can be passed to the screensaver using the same format as the command line in the 'saverParameters'
 * attribute. set 'development' to true for extra information. Both these parameters are optional.
 *
...
/*
    ...
    *//**
     * The number of 'frames per second', at which to render this animation.
     *//*
    public static final int FPS = 60;

    *//**
     * Creates the applet to show the given screensaver. Starts the screensaver right away.
     *//*
    @Override
    public void init() {
        ...
        try {
            ...
            String names[] = screensaverClassName.split("[.]"), name = "";
    ...
    *//**
     * Dumps the string and error message to system error stream, shows it in a pop-up message if development swith
     * enabled.
     *//*
